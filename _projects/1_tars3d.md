...
img: assets/img/google-sites/robotics-collage-1.jpg
importance: 1
category: work
---
...
The project started in November 2022 as a personal side project with zero funding or formal affiliation. Over seven iterative prototypes and two years of weekends, it grew into a full research effort. My longtime collaborator [Abhishek Warrier](https://scholar.google.com/) later joined to extend the work with reinforcement learning, and we co-authored a paper that was accepted at **IEEE Humanoids 2025** in Seoul, where it was named a **finalist for the Mike Stilman Award for Outstanding Research Paper** — competing against 80+ institutions from 20+ countries.
...
- Featured by [Carnegie Mellon University Robotics Institute](https://www.ri.cmu.edu/)
- Featured by [Wevolver](https://www.wevolver.com/)
