...
img: assets/img/google-sites/atrias-biped-cmu.jpg
importance: 3
category: work
---

As a **Graduate Student Researcher at Carnegie Mellon University's Robotics Institute**, I worked with [Prof. Hartmut Geyer](https://www.cs.cmu.edu/~hgeyer/) on optimal control of highly non-linear, dynamic, and underactuated legged systems.

<div class="row">
    <div class="col-sm-8 mt-3 mt-md-0 mx-auto">
        {% include figure.liquid loading="eager" path="assets/img/google-sites/atrias-biped-cmu.jpg" title="ATRIAS biped robot at CMU Robotics Institute" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
